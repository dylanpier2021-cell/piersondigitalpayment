...
A full rebrand from **Pierson Pay → Transfado** ("the new way to get paid") plus a design-system overhaul and a wave of real-processor features.

### Brand & design
- Renamed everywhere (titles, nav, footers, console banner, `platformName`, statement-descriptor default, package name) — kept **Pierson Digital** as the parent and internal `pierson*` code fields intact.
